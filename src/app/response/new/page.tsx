...
export default function NewResponsePage() {
  ...
  return (
    <section className="max-w-3xl mx-auto p-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Create New Response</h1>
      ...
      >
        ...
        <div className="flex justify-between mt-4">
          <button
            ...
            className="px-6 py-3 bg-gray-200 text-gray-800 rounded-md font-semibold transition hover:bg-gray-300"
          >
            Cancel
          </button>
